                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1" role="group">
                                            ...
                                            @if ($item->canStart())
                                                <form
                                                    action="{{ route('banglola.pemeliharaan.start', $item->pemeliharaan_id) }}"
                                            ...
                                            @if ($item->canFinish())
                                                <form
                                                    action="{{ route('banglola.pemeliharaan.finish', $item->pemeliharaan_id) }}"
                                                    method="POST" class="d-inline"
                                            ...
                                            @if ($item->canCancel())
                                                <form
                                                    action="{{ route('banglola.pemeliharaan.cancel', $item->pemeliharaan_id) }}"
                                                    method="POST" class="d-inline"
                                            ...
                                            @if ($item->status_pemeliharaan !== 'berlangsung')
                                                <form
                                                    action="{{ route('banglola.pemeliharaan.destroy', $item->pemeliharaan_id) }}"
                                                    method="POST" class="d-inline"
                                    ...
                                    <div class="modal fade" id="editModal{{ $item->pemeliharaan_id }}" tabindex="-1">
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content border-0 shadow-lg">
                                                ...
                                                <form
                                                    action="{{ route('banglola.pemeliharaan.update', $item->pemeliharaan_id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
