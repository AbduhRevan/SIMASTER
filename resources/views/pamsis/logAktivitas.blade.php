...
<div class="container-fluid py-3">
    ...
    <div class="card shadow-sm border-0 rounded-3">
        ...
        <div class="card-body p-4">
            {{-- Filter Section --}}
            <form method="GET" action="{{ route('superadmin.logAktivitas') }}" class="row g-3 mb-4">
                ...
                <div class="col-lg-1">
                    <a href="{{ route('superadmin.logAktivitas') }}" class="btn btn-outline-secondary w-100" title="Reset Filter">
