...
<div class="modal fade" id="tambahModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form id="serverForm" action="{{ route('pamsis.server.store') }}" method="POST">
                @csrf
                <div class="modal-body p-4">
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    function loadAvailableSlots(rakId) {
        ...
        $.ajax({
            url: `/pamsis/server/rak/${rakId}/available-slots`, // ✅ FIX: Ganti ke pamsis
            type: 'GET',
            dataType: 'json',
    ...
    $(document).on('click', '.btn-edit-server', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#editServerForm').attr('action', `/pamsis/server/update/${s.server_id}`);
    ...
    $(document).on('click', '.btn-hapus', function() {
        ...
        $('#formHapusServer').attr('action', `/pamsis/server/${id}`);
