                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    @if($item->canStart())
                                        <form action="{{ route('tatausaha.pemeliharaan.start', $item->pemeliharaan_id) }}" 
                                    ...
                                    @if($item->canCancel())
                                        <form action="{{ route('tatausaha.pemeliharaan.cancel', $item->pemeliharaan_id) }}" 
                                            method="POST" class="d-inline"
                                    ...
                                    @if($item->status_pemeliharaan !== 'berlangsung')
                                        <form action="{{ route('tatausaha.pemeliharaan.destroy', $item->pemeliharaan_id) }}" 
                                            method="POST" class="d-inline"
                        ...
                        <div class="modal fade" id="editModal{{ $item->pemeliharaan_id }}" tabindex="-1">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content border-0 shadow-lg">
                                    ...
                                    <form action="{{ route('tatausaha.pemeliharaan.update', $item->pemeliharaan_id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
...
<div class="modal fade" id="tambahPemeliharaanModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form action="{{ route('tatausaha.pemeliharaan.store') }}" method="POST">
                @csrf
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-md-6">
