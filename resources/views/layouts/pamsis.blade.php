...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu-container">
            <!-- Dashboard -->
            <a href="{{ route('pamsis.dashboard') }}" class="menu-link {{ request()->is('pamsis/dashboard') ? 'active' : '' }}">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('pamsis.server.index') }}" class="menu-link {{ request()->routeIs('pamsis.server.*') ? 'active' : '' }}">
                    <i class="fa-solid fa-database"></i>
                    <span>Server</span>
                </a>
                <a href="{{ route('pamsis.website.index') }}" class="menu-link {{ request()->routeIs('pamsis.website.*') ? 'active' : '' }}">
                    <i class="fa-solid fa-globe"></i>
                    <span>Website</span>
                </a>
                <a href="{{ route('pamsis.pemeliharaan') }}" class="menu-link {{ request()->routeIs('pamsis.pemeliharaan') ? 'active' : '' }}">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('pamsis.logAktivitas') }}" class="menu-link {{ request()->routeIs('pamsis.logAktivitas') ? 'active' : '' }}">
