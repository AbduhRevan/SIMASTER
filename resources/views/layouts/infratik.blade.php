...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu-container">
            <!-- Dashboard -->
            <a href="{{ route('infratik.dashboard') }}" class="menu-link {{ request()->is('infratik/dashboard') ? 'active' : '' }}">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('infratik.server.index') }}" class="menu-link {{ request()->routeIs('infratik.server.*') ? 'active' : '' }}">
                    <i class="fa-solid fa-database"></i>
                    <span>Server</span>
                </a>
                <a href="{{ route('infratik.website.index') }}" class="menu-link {{ request()->routeIs('infratik.website.*') ? 'active' : '' }}">
                    <i class="fa-solid fa-globe"></i>
                    <span>Website</span>
                </a>
                <a href="{{ route('infratik.pemeliharaan') }}" class="menu-link {{ request()->routeIs('infratik.pemeliharaan') ? 'active' : '' }}">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('infratik.logAktivitas') }}" class="menu-link {{ request()->routeIs('infratik.logAktivitas') ? 'active' : '' }}">
