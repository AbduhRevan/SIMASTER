...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu-container">
            <!-- Dashboard -->
            <a href="{{ route('tatausaha.dashboard') }}" class="menu-link {{ request()->is('tatausaha/dashboard') ? 'active' : '' }}">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('tatausaha.server.index') }}" class="menu-link {{ request()->routeIs('tatausaha.server.*') ? 'active' : '' }}">
                    <i class="fa-solid fa-database"></i>
                    <span>Server</span>
                </a>
                <a href="{{ route('tatausaha.website.index') }}" class="menu-link {{ request()->routeIs('tatausaha.website.*') ? 'active' : '' }}">
                    <i class="fa-solid fa-globe"></i>
                    <span>Website</span>
                </a>
                <a href="{{ route('tatausaha.pemeliharaan') }}" class="menu-link {{ request()->routeIs('tatausaha.pemeliharaan') ? 'active' : '' }}">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('tatausaha.logAktivitas') }}" class="menu-link {{ request()->routeIs('tatausaha.logAktivitas') ? 'active' : '' }}">
