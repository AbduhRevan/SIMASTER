...
{{-- Filter untuk Export --}}
<form id="filterServerForm" method="GET" action="{{ route('server.index') }}" class="mb-3">
    <div class="row g-2 align-items-end">
        ...
        {{-- Tombol Reset --}}
        <div class="col-md-2">
            <a href="{{ route('server.index') }}" class="btn btn-outline-secondary btn-sm w-100">
...
function exportServerPDF() {
    ...
    const url = new URL('{{ route("server.export.pdf") }}', window.location.origin);
